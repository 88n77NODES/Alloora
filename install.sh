...
rpc_replace_url="https://example.com/rpc_replace.sh"  
custom_model_url="https://example.com/custom_model.sh" 
basic_model_url="https://example.com/basic_model.sh"  
